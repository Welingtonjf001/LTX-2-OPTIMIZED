"""LTX-2.5 variant of film_maker_ui_v4.py -- GENERATED by _make_25_uis.py, do not hand-edit
...
Differences from the 2.3 original:
  ...
  - Gradio port moved to 7961 so this can run alongside the 2.3 UI.
...
with gr.Blocks(title="LTX-2.5 Film Maker") as demo:
