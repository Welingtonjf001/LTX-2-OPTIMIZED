"""LTX-2.5 variant of music_maker_ui_v3.py -- GENERATED by _make_25_uis.py, do not hand-edit
...
Differences from the 2.3 original:
  ...
  - Gradio port moved to 7904 so this can run alongside the 2.3 UI.
...
with gr.Blocks(title="LTX-2.5 Music Video Maker V3 - LatentSync 1.6") as demo:
