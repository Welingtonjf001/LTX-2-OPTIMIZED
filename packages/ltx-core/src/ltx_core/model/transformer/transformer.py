...
class BasicAVTransformerBlock(torch.nn.Module):
    ...
    def forward(  # noqa: PLR0915
                ...
                is_conditioning: bool = True # TODO: add optimization for disabled audio
            ...
            return replace(video, x=vx) if video is not None else None, replace(audio,
                                                                                x=ax) if audio is not None else None

    def forward_(  # noqa: PLR0915
            self,
            video: TransformerArgs | None,
            audio: TransformerArgs | None,
            perturbations: BatchedPerturbationConfig | None = None,
